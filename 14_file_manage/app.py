# Student Management System - With Persistent Data
...
def save_students():
    ...
    # TypeError: Object of type set is not JSON serializable -> convert to list
    json_data_fix = {
        sid: {
            "name": data['name'],
            "scores": data['scores'],
    ...
    with open(FILE_NAME,"w") as file:
        json.dump(json_data_fix,file,indent=4)
